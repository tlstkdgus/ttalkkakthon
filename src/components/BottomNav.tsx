...
export function BottomNav() {
  ...
  return (
    <nav
      className={cn(
        'fixed bottom-0 left-0 right-0 z-40 mx-auto max-w-md border-t backdrop-blur-md',
        isSecret
          ? 'border-white/10 bg-secret-bg/85'
          : 'border-slate-200/80 bg-boss-bg/85',
      )}
      aria-label="주요 메뉴"
    >
      <div className="mx-auto flex max-w-md pb-[max(0.35rem,env(safe-area-inset-bottom))]">
