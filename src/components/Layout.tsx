  ...
  return (
    ...
    >
      <div
        className={cn(
          appShellClass,
          'flex min-h-[100dvh] flex-col px-3 pb-[4.25rem] pt-4 sm:px-5 sm:pb-16 sm:pt-5 md:pb-20',
        )}
      >
        {isSecret ? (
          <div className="excel-panel flex min-h-0 max-h-[calc(100dvh-5rem)] flex-1 flex-col overflow-hidden">
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            <div className="win95-window flex min-h-0 max-h-[calc(100dvh-5rem)] flex-1 flex-col overflow-hidden">
              <header className="flex shrink-0 items-center justify-between bg-boss-primary px-2 py-1.5 sm:px-3">
